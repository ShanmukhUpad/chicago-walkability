...
metro_walk_map
tmap_save(metro_walk_map, "poster_figures/fig_metro_walk.png", width = 10, height = 8, dpi = 200)
```
...
city_walk_map <- tm_shape(chicago_city) +
  ...
  tm_scalebar(position = c("left", "bottom"))
city_walk_map
tmap_save(city_walk_map, "poster_figures/fig_city_walk.png", width = 10, height = 8, dpi = 200)
```
...
tmap_save(tm0, "poster_figures/fig_city_jenks.png", width = 10, height = 8, dpi = 200)
```
...
tmap_save(tm3, "poster_figures/fig_econ_opportunity.png", width = 8, height = 8, dpi = 200)
```
...
if (city_moran$p.value < 0.05) {
  ...
  print(city_lisa_map)
  tmap_save(city_lisa_map, "poster_figures/fig_lisa_city.png", width = 10, height = 8, dpi = 200)
} else {
...
ggsave("poster_figures/fig_scatter_entropy.png", width = 10, height = 6, dpi = 200)
```
...
png("poster_figures/fig_scatterplot_matrix.png", width = 1600, height = 1200, res = 200)
pairs(pairs_data,
